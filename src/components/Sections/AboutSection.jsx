...
const AboutSection = ({ language }) => {
  ...
  const stats = [
    ...
    <section 
      className="py-16 lg:py-24 text-white relative z-100" 
      id="about"
      style={{
        background: 'linear-gradient(135deg, #2A315D 0%, #2A315D 50%, #3A4570 100%)',
        position: 'relative'
      }}
    >      {/* Wave pattern overlay */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Row gutter={[32, 48]} align="middle">
          <Col xs={24} lg={12}>
            <div className="relative">              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <LazyImage 
                  ...
                  loadingClassName="flex items-center justify-center bg-gray-700 h-96"
                />
                ...
                <LazyImage 
                  ...
                  loadingClassName="flex items-center justify-center bg-gray-700 h-full"
                />
              </div>
            </div>
          </Col>
          ...
          <Col xs={24} lg={12}>
            <div className="space-y-6">
              <div>
                ...
                </p>                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                  {content.title}
                </h2>
              </div>
          ...
          {features.map((feature, index) => (
            <SlideUpAnimation key={index} delay={index * 150}>
              <Card 
                className="!border-0 !shadow-lg hover:!shadow-xl transition-shadow duration-300 !rounded-xl !bg-white/10 !backdrop-blur-sm"
                hoverable
              >
        ...
        <SlideUpAnimation delay={600}>
          <div className="bg-primary-500 rounded-2xl p-8 lg:p-12 mt-16 text-center">
